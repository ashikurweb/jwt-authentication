<template>
  <div class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
        <h1 class="text-3xl font-black theme-text-main tracking-tight">Course Categories</h1>
        <p class="text-sm theme-text-muted mt-1 font-medium">Organize your courses into meaningful categories.</p>
      </div>
    ...
    <div class="relative min-h-[400px]">
      ...
      <div class="grid grid-cols-12 gap-4 px-8 py-4 mb-4 theme-table-header rounded-2xl shadow-sm overflow-hidden relative group/header">
        ...
        <div class="col-span-1 text-[10px] font-black theme-table-header-text uppercase tracking-[0.2em] text-center">Courses</div>
      ...
      <template v-else>
        ...
        <EmptyState 
          ...
          message="Start organizing your content by creating a new category and grouping your courses."
        />
