<template>
  <div class="group" :style="{ marginLeft: depth > 0 ? `${depth * 24}px` : '0' }">
    <div class="flex gap-3">
      ...
      <div class="flex-1">
        <!-- Comment Box -->
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/50 rounded-2xl p-4 shadow-sm">
        ...
        <!-- Nested Replies -->
        <div v-if="comment.allReplies?.length" class="mt-4 space-y-4 border-l-2 border-slate-100 dark:border-slate-800 pl-4">
          <CommentItem 
